...
static_assert(sizeof(IDBTransaction_Put_Params_Data) == 48,
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(IDBTransaction_Put_ResponseParams_Data));
      new (data()) IDBTransaction_Put_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    IDBTransaction_Put_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<IDBTransaction_Put_ResponseParams_Data>(index_);
    }
    IDBTransaction_Put_ResponseParams_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(IDBDatabase_Get_ResponseParams_Data));
      new (data()) IDBDatabase_Get_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    IDBDatabase_Get_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<IDBDatabase_Get_ResponseParams_Data>(index_);
    }
    IDBDatabase_Get_ResponseParams_Data* operator->() { return data(); }
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(IDBDatabase_GetAll_ResponseParams_Data));
      new (data()) IDBDatabase_GetAll_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    IDBDatabase_GetAll_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<IDBDatabase_GetAll_ResponseParams_Data>(index_);
    }
    IDBDatabase_GetAll_ResponseParams_Data* operator->() { return data(); }
  ...
  mojo::internal::StructHeader header_;
  internal::IDBDatabaseGetAllResult_Data result;

 private:
  IDBDatabase_GetAll_ResponseParams_Data();
  ~IDBDatabase_GetAll_ResponseParams_Data() = delete;
};
static_assert(sizeof(IDBDatabase_GetAll_ResponseParams_Data) == 24,
 ...
 public:
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(IDBDatabase_OpenCursor_ResponseParams_Data));
      new (data()) IDBDatabase_OpenCursor_ResponseParams_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    IDBDatabase_OpenCursor_ResponseParams_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<IDBDatabase_OpenCursor_ResponseParams_Data>(index_);
    }
    IDBDatabase_OpenCursor_ResponseParams_Data* operator->() { return data(); }
  ...
  UserType TakePendingDatabase() {
    ...
    bool ret =
        mojo::internal::Deserialize<::blink::mojom::IDBDatabaseAssociatedPtrInfoDataView>(
            &data_->pending_database, &result, context_);
    DCHECK(ret);
    return result;
  }
  ...
  UserType TakeTransactionReceiver() {
    ...
    bool ret =
        mojo::internal::Deserialize<::blink::mojom::IDBTransactionAssociatedRequestDataView>(
            &data_->transaction_receiver, &result, context_);
    DCHECK(ret);
    return result;
  }
  int64_t transaction_id() const {
...
class IDBDatabase_GetAll_ResponseParamsDataView {
 public:
  ...
  bool is_null() const { return !data_; }
  inline void GetResultDataView(
      IDBDatabaseGetAllResultDataView* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadResult(UserType* output) {
    auto* pointer = !data_->result.is_null() ? &data_->result : nullptr;
    return mojo::internal::Deserialize<::blink::mojom::IDBDatabaseGetAllResultDataView>(
        pointer, output, context_);
  }
 private:
  ...
  UserType TakePendingCallbacks() {
    ...
    bool ret =
        mojo::internal::Deserialize<::blink::mojom::IDBCallbacksAssociatedPtrInfoDataView>(
            &data_->pending_callbacks, &result, context_);
    DCHECK(ret);
    return result;
  }
 private:
...
class IDBFactory_Open_ParamsDataView {
 public:
  ...
  UserType TakeVersionChangeTransactionReceiver() {
    ...
    bool ret =
        mojo::internal::Deserialize<::blink::mojom::IDBTransactionAssociatedRequestDataView>(
            &data_->version_change_transaction_receiver, &result, context_);
    DCHECK(ret);
    return result;
  }
  int64_t transaction_id() const {
...
inline void IDBCursor_Advance_ResponseParamsDataView::GetResultDataView(
  ...
  *output = IDBCursorResultDataView(pointer, context_);
}
...
inline void IDBTransaction_Put_ResponseParamsDataView::GetResultDataView(
    IDBTransactionPutResultDataView* output) {
  auto pointer = &data_->result;
  *output = IDBTransactionPutResultDataView(pointer, context_);
}
...
inline void IDBDatabase_Get_ResponseParamsDataView::GetResultDataView(
    IDBDatabaseGetResultDataView* output) {
  auto pointer = &data_->result;
  *output = IDBDatabaseGetResultDataView(pointer, context_);
}
...
inline void IDBDatabase_GetAll_ResponseParamsDataView::GetResultDataView(
    IDBDatabaseGetAllResultDataView* output) {
  auto pointer = &data_->result;
  *output = IDBDatabaseGetAllResultDataView(pointer, context_);
}
...
inline void IDBDatabase_OpenCursor_ResponseParamsDataView::GetResultDataView(
    IDBDatabaseOpenCursorResultDataView* output) {
  auto pointer = &data_->result;
  *output = IDBDatabaseOpenCursorResultDataView(pointer, context_);
}

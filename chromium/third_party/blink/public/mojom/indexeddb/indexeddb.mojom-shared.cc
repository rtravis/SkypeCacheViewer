...
bool IDBKeyData_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case IDBKeyData_Tag::OTHER_NONE: {
...
bool IDBTransactionPutResult_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case IDBTransactionPutResult_Tag::KEY: {
      ...
      if (!mojo::internal::ValidateStruct(object->data.f_key, validation_context))
        return false;
      return true;
    }
    default: {
...
// static
bool IDBDatabaseGetAllResult_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context,
    bool inlined) {
  if (!data) {
  ...
  const IDBDatabaseGetAllResult_Data* object = static_cast<const IDBDatabaseGetAllResult_Data*>(data);
  ALLOW_UNUSED_LOCAL(object);
  ...
  switch (object->tag) {
    ...
    case IDBDatabaseGetAllResult_Tag::ERROR_RESULT: {
    ...
    case IDBDatabaseGetAllResult_Tag::KEY: {
    ...
    case IDBDatabaseGetAllResult_Tag::VALUES: {
    ...
    default: {
      ReportValidationError(
          validation_context,
          mojo::internal::VALIDATION_ERROR_UNKNOWN_UNION_TAG,
          "unknown tag in IDBDatabaseGetAllResult");
      return false;
    }
  }
}

...
class MODULES_EXPORT IDBCallbacks
 ...
 public:
  ...
  virtual void UpgradeNeeded(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss, const WTF::String& data_loss_message, const ::blink::IDBDatabaseMetadata& db_metadata) = 0;

  
  virtual void SuccessDatabase(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, const ::blink::IDBDatabaseMetadata& metadata) = 0;
...
class MODULES_EXPORT IDBTransaction
 ...
 public:
  ...
  virtual void Put(int64_t object_store_id, ::std::unique_ptr<::blink::IDBValue> value, ::std::unique_ptr<::blink::IDBKey> key, IDBPutMode mode, WTF::Vector<::blink::IDBIndexKeys> index_keys, PutCallback callback) = 0;
...
class MODULES_EXPORT IDBDatabase
 ...
 public:
  ...
  virtual void CreateTransaction(mojo::PendingAssociatedReceiver<IDBTransaction> transaction_receiver, int64_t transaction_id, const WTF::Vector<int64_t>& object_store_ids, IDBTransactionMode mode) = 0;
  ...
  virtual void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, bool key_only, int64_t max_count, GetAllCallback callback) = 0;
  ...
  virtual void OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, OpenCursorCallback callback) = 0;

  
  virtual void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) = 0;

  
  virtual void DeleteRange(int64_t transaction_id, int64_t object_store_id, IDBKeyRangePtr key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) = 0;
...
class MODULES_EXPORT IDBFactory
 ...
 public:
  ...
  virtual void Open(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::WTF::String& name, int64_t version, mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) = 0;

  
  virtual void DeleteDatabase(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, const ::WTF::String& name, bool force_close) = 0;
...
class MODULES_EXPORT IDBCallbacksProxy
 ...
 public:
  ...
  void UpgradeNeeded(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss, const WTF::String& data_loss_message, const ::blink::IDBDatabaseMetadata& db_metadata) final;
  
  void SuccessDatabase(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, const ::blink::IDBDatabaseMetadata& metadata) final;
...
class MODULES_EXPORT IDBTransactionProxy
 ...
 public:
  ...
  void Put(int64_t object_store_id, ::std::unique_ptr<::blink::IDBValue> value, ::std::unique_ptr<::blink::IDBKey> key, IDBPutMode mode, WTF::Vector<::blink::IDBIndexKeys> index_keys, PutCallback callback) final;
...
class MODULES_EXPORT IDBDatabaseProxy
 ...
 public:
  ...
  void CreateTransaction(mojo::PendingAssociatedReceiver<IDBTransaction> transaction_receiver, int64_t transaction_id, const WTF::Vector<int64_t>& object_store_ids, IDBTransactionMode mode) final;
  ...
  void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, bool key_only, int64_t max_count, GetAllCallback callback) final;
  ...
  void OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, OpenCursorCallback callback) final;
  
  void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) final;
  
  void DeleteRange(int64_t transaction_id, int64_t object_store_id, IDBKeyRangePtr key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) final;
...
class MODULES_EXPORT IDBFactoryProxy
 ...
 public:
  ...
  void Open(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::WTF::String& name, int64_t version, mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) final;
  
  void DeleteDatabase(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, const ::WTF::String& name, bool force_close) final;
...
class MODULES_EXPORT IDBDatabaseGetAllResult {
 public:
  ...
  static IDBDatabaseGetAllResultPtr
  NewValues(
      WTF::Vector<IDBReturnValuePtr> values) {
    auto result = IDBDatabaseGetAllResultPtr(base::in_place);
    result->set_values(std::move(values));
    return result;
  }
  ...
  WTF::Vector<IDBReturnValuePtr>& get_values() const {
    DCHECK(tag_ == Tag::VALUES);
    return *(data_.values);
  }
...
class MODULES_EXPORT IDBDatabaseOpenCursorValue {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IDBDatabaseOpenCursorValue::DataView, WTF::Vector<uint8_t>>(input);
  }
...
struct MODULES_EXPORT StructTraits<::blink::mojom::blink::IDBDatabaseMetadata::DataView,
  ...
  static decltype(::blink::mojom::blink::IDBDatabaseMetadata::was_cold_open) was_cold_open(
      const ::blink::mojom::blink::IDBDatabaseMetadataPtr& input) {
...
struct MODULES_EXPORT StructTraits<::blink::mojom::blink::IDBDatabaseOpenCursorValue::DataView,
  ...
  static bool IsNull(const ::blink::mojom::blink::IDBDatabaseOpenCursorValuePtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::IDBDatabaseOpenCursorValuePtr* output) { output->reset(); }

  static  decltype(::blink::mojom::blink::IDBDatabaseOpenCursorValue::cursor)& cursor(
       ::blink::mojom::blink::IDBDatabaseOpenCursorValuePtr& input) {
    return input->cursor;
  }

  static const decltype(::blink::mojom::blink::IDBDatabaseOpenCursorValue::key)& key(
  ...
  static  decltype(::blink::mojom::blink::IDBDatabaseOpenCursorValue::value)& value(
       ::blink::mojom::blink::IDBDatabaseOpenCursorValuePtr& input) {
    return input->value;
  }
...
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBKeyData::DataView,
  ...
  static  bool other_none(const ::blink::mojom::blink::IDBKeyDataPtr& input) {
...
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBCursorResult::DataView,
  ...
  static bool IsNull(const ::blink::mojom::blink::IDBCursorResultPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::IDBCursorResultPtr* output) { output->reset(); }
...
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBTransactionPutResult::DataView,
  ...
  static bool IsNull(const ::blink::mojom::blink::IDBTransactionPutResultPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::IDBTransactionPutResultPtr* output) { output->reset(); }
...
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBDatabaseGetResult::DataView,
  ...
  static bool IsNull(const ::blink::mojom::blink::IDBDatabaseGetResultPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::IDBDatabaseGetResultPtr* output) { output->reset(); }
...
template <>
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBDatabaseGetAllResult::DataView,
                                        ::blink::mojom::blink::IDBDatabaseGetAllResultPtr> {
  static bool IsNull(const ::blink::mojom::blink::IDBDatabaseGetAllResultPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::IDBDatabaseGetAllResultPtr* output) { output->reset(); }

  static ::blink::mojom::blink::IDBDatabaseGetAllResult::Tag GetTag(const ::blink::mojom::blink::IDBDatabaseGetAllResultPtr& input) {
    return input->which();
  }

  static const ::blink::mojom::blink::IDBErrorPtr& error_result(const ::blink::mojom::blink::IDBDatabaseGetAllResultPtr& input) {
    return input->get_error_result();
  }

  static const ::std::unique_ptr<::blink::IDBKey>& key(const ::blink::mojom::blink::IDBDatabaseGetAllResultPtr& input) {
    return input->get_key();
  }

  static  WTF::Vector<::blink::mojom::blink::IDBReturnValuePtr>& values( ::blink::mojom::blink::IDBDatabaseGetAllResultPtr& input) {
    return input->get_values();
  }

  static bool Read(::blink::mojom::blink::IDBDatabaseGetAllResult::DataView input, ::blink::mojom::blink::IDBDatabaseGetAllResultPtr* output);
};
...
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBDatabaseOpenCursorResult::DataView,
  ...
  static bool IsNull(const ::blink::mojom::blink::IDBDatabaseOpenCursorResultPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::IDBDatabaseOpenCursorResultPtr* output) { output->reset(); }

...
typedef mojo::StructPtr<IDBCursorResult> IDBCursorResultPtr;

class IDBTransactionPutResult;

typedef mojo::StructPtr<IDBTransactionPutResult> IDBTransactionPutResultPtr;

class IDBDatabaseGetResult;

typedef mojo::StructPtr<IDBDatabaseGetResult> IDBDatabaseGetResultPtr;

class IDBDatabaseGetAllResult;

typedef mojo::StructPtr<IDBDatabaseGetAllResult> IDBDatabaseGetAllResultPtr;

class IDBDatabaseOpenCursorResult;

typedef mojo::StructPtr<IDBDatabaseOpenCursorResult> IDBDatabaseOpenCursorResultPtr;

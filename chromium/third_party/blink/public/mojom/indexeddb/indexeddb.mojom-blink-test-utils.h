...
class MODULES_EXPORT IDBCallbacksInterceptorForTesting : public IDBCallbacks {
  ...
  void UpgradeNeeded(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss, const WTF::String& data_loss_message, const ::blink::IDBDatabaseMetadata& db_metadata) override;
  void SuccessDatabase(mojo::PendingAssociatedRemote<IDBDatabase> pending_database, const ::blink::IDBDatabaseMetadata& metadata) override;
...
class MODULES_EXPORT IDBTransactionInterceptorForTesting : public IDBTransaction {
  ...
  void Put(int64_t object_store_id, ::std::unique_ptr<::blink::IDBValue> value, ::std::unique_ptr<::blink::IDBKey> key, IDBPutMode mode, WTF::Vector<::blink::IDBIndexKeys> index_keys, PutCallback callback) override;
...
class MODULES_EXPORT IDBDatabaseInterceptorForTesting : public IDBDatabase {
  ...
  void CreateTransaction(mojo::PendingAssociatedReceiver<IDBTransaction> transaction_receiver, int64_t transaction_id, const WTF::Vector<int64_t>& object_store_ids, IDBTransactionMode mode) override;
  void Close() override;
  ...
  void OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, OpenCursorCallback callback) override;
  void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) override;
  void DeleteRange(int64_t transaction_id, int64_t object_store_id, IDBKeyRangePtr key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) override;
...
class MODULES_EXPORT IDBDatabaseAsyncWaiter {
 public:
  ...
  void GetAll(
      int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, bool key_only, int64_t max_count, IDBDatabaseGetAllResultPtr* out_result);
  void OpenCursor(
...
class MODULES_EXPORT IDBFactoryInterceptorForTesting : public IDBFactory {
  ...
  void Open(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::WTF::String& name, int64_t version, mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) override;
  void DeleteDatabase(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, const ::WTF::String& name, bool force_close) override;

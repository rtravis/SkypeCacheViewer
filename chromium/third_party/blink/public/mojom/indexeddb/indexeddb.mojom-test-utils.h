...
class BLINK_COMMON_EXPORT IDBCursorAsyncWaiter {
 public:
  ...
  void CursorContinue(
      const ::blink::IndexedDBKey& key, const ::blink::IndexedDBKey& primary_key, IDBCursorResultPtr* out_result);
  void Prefetch(
...
class BLINK_COMMON_EXPORT IDBTransactionInterceptorForTesting : public IDBTransaction {
  ...
  void Put(int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode, const std::vector<::blink::IndexedDBIndexKeys>& index_keys, PutCallback callback) override;
...
class BLINK_COMMON_EXPORT IDBTransactionAsyncWaiter {
 public:
  ...
  void Put(
      int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode, const std::vector<::blink::IndexedDBIndexKeys>& index_keys, IDBTransactionPutResultPtr* out_result);
...
class BLINK_COMMON_EXPORT IDBDatabaseInterceptorForTesting : public IDBDatabase {
  ...
  void CreateTransaction(mojo::PendingAssociatedReceiver<IDBTransaction> transaction_receiver, int64_t transaction_id, const std::vector<int64_t>& object_store_ids, IDBTransactionMode mode) override;
  void Close() override;
  ...
  void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, int64_t max_count, GetAllCallback callback) override;
  ...
  void OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, OpenCursorCallback callback) override;
  void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) override;
  void DeleteRange(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKeyRange& key_range, mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) override;
...
class BLINK_COMMON_EXPORT IDBDatabaseAsyncWaiter {
 public:
  ...
  void Get(
      int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, IDBDatabaseGetResultPtr* out_result);
  void GetAll(
      int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, int64_t max_count, IDBDatabaseGetAllResultPtr* out_result);
  void OpenCursor(
      int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, IDBCursorDirection direction, bool key_only, IDBTaskType task_type, IDBDatabaseOpenCursorResultPtr* out_result);
...
class BLINK_COMMON_EXPORT IDBFactoryInterceptorForTesting : public IDBFactory {
  ...
  void GetDatabaseNames(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) override;
  void Open(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::base::string16& name, int64_t version, mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) override;
  void DeleteDatabase(mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, const ::base::string16& name, bool force_close) override;

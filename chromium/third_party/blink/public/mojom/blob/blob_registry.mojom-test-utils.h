...
class BLINK_COMMON_EXPORT BlobRegistryInterceptorForTesting : public BlobRegistry {
  ...
  void GetBlobFromUUID(mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid, GetBlobFromUUIDCallback callback) override;
  void URLStoreForOrigin(const ::url::Origin& origin, mojo::PendingAssociatedReceiver<::blink::mojom::BlobURLStore> url_store) override;
};
class BLINK_COMMON_EXPORT BlobRegistryAsyncWaiter {
 public:
  ...
  void GetBlobFromUUID(
      mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid);

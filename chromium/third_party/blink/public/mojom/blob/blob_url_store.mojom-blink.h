...
class PLATFORM_EXPORT BlobURLStore
 ...
 public:
  ...
  virtual void ResolveForNavigation(const ::blink::KURL& url, mojo::PendingReceiver<BlobURLToken> token) = 0;
};
...
class PLATFORM_EXPORT BlobURLStoreProxy
 ...
 public:
  ...
  void ResolveForNavigation(const ::blink::KURL& url, mojo::PendingReceiver<BlobURLToken> token) final;

...
class BLINK_COMMON_EXPORT BlobURLStore
 ...
 public:
  ...
  virtual void ResolveForNavigation(const ::GURL& url, mojo::PendingReceiver<BlobURLToken> token) = 0;
};
...
class BLINK_COMMON_EXPORT BlobURLStoreProxy
 ...
 public:
  ...
  void ResolveForNavigation(const ::GURL& url, mojo::PendingReceiver<BlobURLToken> token) final;

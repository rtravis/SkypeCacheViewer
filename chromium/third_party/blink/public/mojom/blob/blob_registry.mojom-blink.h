...
class PLATFORM_EXPORT BlobRegistry
 ...
 public:
  ...
  virtual void URLStoreForOrigin(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingAssociatedReceiver<::blink::mojom::blink::BlobURLStore> url_store) = 0;
};
...
class PLATFORM_EXPORT BlobRegistryProxy
 ...
 public:
  ...
  void URLStoreForOrigin(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, mojo::PendingAssociatedReceiver<::blink::mojom::blink::BlobURLStore> url_store) final;

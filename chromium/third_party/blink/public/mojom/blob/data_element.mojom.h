...
class BLINK_COMMON_EXPORT DataElementBytes {
 public:
  ...
  DataElementBytes(
      uint64_t length,
      const base::Optional<std::vector<uint8_t>>& embedded_data,
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DataElementBytes::DataView, std::vector<uint8_t>>(input);
  }
  ...
  base::Optional<std::vector<uint8_t>> embedded_data;
...
class BLINK_COMMON_EXPORT DataElementFilesystemURL {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<DataElementFilesystemURL, T>::value>;
  ...
  // bindings generator does not need to know whether Equals() or == operator
  // are available for members.
  template <typename T, DataElementFilesystemURL::EnableIfSame<T>* = nullptr>
  bool Equals(const T& other) const;

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DataElementFilesystemURL::DataView, std::vector<uint8_t>>(input);
  }
...
class BLINK_COMMON_EXPORT DataElementBlob {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DataElementBlob::DataView, std::vector<uint8_t>>(input);
  }
...
template <typename T, DataElementFilesystemURL::EnableIfSame<T>*>
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DataElementFilesystemURL::DataView,
                                         ::blink::mojom::DataElementFilesystemURLPtr> {
  static bool IsNull(const ::blink::mojom::DataElementFilesystemURLPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::DataElementFilesystemURLPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::DataElementFilesystemURL::url)& url(
      const ::blink::mojom::DataElementFilesystemURLPtr& input) {
    return input->url;
  }

  static decltype(::blink::mojom::DataElementFilesystemURL::offset) offset(
      const ::blink::mojom::DataElementFilesystemURLPtr& input) {
    return input->offset;
  }

  static decltype(::blink::mojom::DataElementFilesystemURL::length) length(
      const ::blink::mojom::DataElementFilesystemURLPtr& input) {
    return input->length;
  }

  static const decltype(::blink::mojom::DataElementFilesystemURL::expected_modification_time)& expected_modification_time(
      const ::blink::mojom::DataElementFilesystemURLPtr& input) {
    return input->expected_modification_time;
  }

  static bool Read(::blink::mojom::DataElementFilesystemURL::DataView input, ::blink::mojom::DataElementFilesystemURLPtr* output);
};
...
struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::DataElement::DataView,
  ...
  static const ::blink::mojom::DataElementFilesystemURLPtr& file_filesystem(const ::blink::mojom::DataElementPtr& input) {
